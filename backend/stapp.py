...
if mode == "Full Project Intelligence": # Full Project Intelligence 
    ...
    uploaded_zip = st.file_uploader(
        ...
        type=["zip"],
        key="project_zip_uploader" # project zip uploader 
    )
    ...
    if "project_result" in st.session_state:
        ...
        if r.get("project_explanation"):
            ...
            st.markdown(r["project_explanation"]) # project explanation

        if r.get("interview_questions"):
            st.subheader("🎯 Interview Questions") # interview questions
            st.markdown(r["interview_questions"]) # interview questions
